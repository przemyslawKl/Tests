...
public class pageElements {
	...
	public static void WomenCategories(WebDriver driver) {
		element = driver.findElement(
				By.xpath("//a[@href='http://automationpractice.com/index.php?id_category=3&controller=category']"));
		element.click();
	}

	public static void SpecialInformations(WebDriver driver) {
		element = driver
				.findElement(By.xpath("//a[@href='http://automationpractice.com/index.php?controller=prices-drop']"));
		element.click();
	}

	public static void NewProductsInformation(WebDriver driver) {
		element = driver
				.findElement(By.xpath("//a[@href='http://automationpractice.com/index.php?controller=new-products']"));
		element.click();
	}
